...
Module Structure:
- core: Fundamental calculations (shared by all modules)
- cfa: CFA curriculum metrics
- frm: FRM curriculum metrics
- cqf: CQF curriculum metrics
- portfolio: Portfolio management frameworks
"""
